...
const FeedbackManager = () => {
  ...
  const sendEmailNotification = async (feedback) => {
    try {
      setEmailStatus('Sending email notification via EmailJS...');
      ...
      if (response.ok) {
        ...
        setEmailStatus('Email notification sent successfully via EmailJS! 🎮');
      ...
      try {
        ...
        const unsubscribe = onSnapshot(q, (snapshot) => {
          ...
          if (previousFeedbackIds.current.size > 0) {
            ...
            // Send email for each new feedback via EmailJS
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">🎮 ProArena Feedback Manager</h1>
        <p className="text-gray-600">Manage and respond to user feedback • Powered by EmailJS</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            <div className="flex-shrink-0">
              <div className="w-8 h-8 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-md flex items-center justify-center">
                <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            <div className="flex-shrink-0">
              <div className="w-8 h-8 bg-gradient-to-r from-green-500 to-blue-500 rounded-md flex items-center justify-center">
                <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            <div className="flex-shrink-0">
              <div className="w-8 h-8 bg-gradient-to-r from-red-500 to-pink-500 rounded-md flex items-center justify-center">
                <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="space-y-4">
        {filteredFeedbacks.length === 0 ? (
          ...
          filteredFeedbacks.map((feedback) => (
            <div key={feedback.id} className={`bg-white rounded-lg shadow transition-all duration-200 hover:shadow-md ${!feedback.isRead ? 'border-l-4 border-l-orange-500' : ''}`}>
              <div className="p-6">
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex items-center gap-2 ml-4">
                    ...
                    <button
                      ...
                      className="inline-flex items-center px-3 py-1.5 border border-gray-300 text-xs font-medium rounded text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 transition-colors"
                    >
                      View Details
                    </button>
                    <button
              ...
              <div className="flex justify-end gap-3 mt-6">
                {!selectedFeedback.isRead && (
                  <button
                    ...
                    className="px-4 py-2 bg-gradient-to-r from-orange-500 to-red-500 text-white text-sm font-medium rounded-md hover:from-orange-600 hover:to-red-600 focus:outline-none focus:ring-2 focus:ring-orange-500 transition-colors"
                  >
                    Mark as Read
                  </button>
                )}
